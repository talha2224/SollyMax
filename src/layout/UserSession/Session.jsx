...
const Session = () => {
    ...
    return (
        <div className='flex flex-col h-[100%] w-[10%] overflow-auto relative'>

            {/* NAV BAR  BUTTONS AND PROFILE ICON */}
            <div className='flex justify-between items-center'>
                <p className='text-white font-semibold'>User session <span className='text-[#FBB101]'>(2000 User)</span></p>
            ...
            <div className='flex-1 flex flex-col items-center w-[100%] h-[100%] shadow-shadow2 bg-[#333333] rounded-[12px] overflow-auto  mt-3'>
                ...
                <div className=' w-[90%] h-[80%] m-5 overflow-y-auto overflow-auto'>
                    {/* HEAD  */}
                    <div className='flex items-center gap-x-6 text-white overflow-auto'>
                        ...
                        <p className='flex-1 text-nowrap  min-w-[10rem]'>Plan Range</p>
                        <p className='flex-1 text-nowrap  min-w-[10rem]'>Expiration</p>
                    ...
                    {/* DATA  */}
                    {
                        count.map((i, index) => (
                            <div className='flex items-center gap-x-6 text-white bg-[#1E1E1E] rounded-md mt-6 overflow-auto h-[3rem] p-2'>
                                ...
                                <div className='flex items-center h-[3rem] min-w-[12.5rem] '>
                                    <p className='mt-[2px]'>Basic</p>
                                </div>

                                <div className='flex items-center min-w-[12.5rem]'>
                                    <p className='mt-[2px]'>1 month</p>
                                </div>

                                <div className='flex items-center min-w-[12.5rem]'>
                                    <p className='mt-[2px]'>7 days left</p>
                                </div>
